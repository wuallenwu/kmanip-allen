...
class REINFORCE:
    ...
    def sample_action(self, state: np.ndarray) -> float:
        ...
        flattened = np.array([v for v in state.values()])
        # print(flattened)
        ...
        keys = ["eel_pos", "eel_orn", "eer_pos", "eer_orn", "grip_l", "grip_r"]
        vals = [action[:3:], action[3:7:], action[7:10:], action[10:14:], action[14:15:], action[15:16:]]
...
obs_space_dims, action_space_dims = 20, 16
rewards_over_seeds = []

for seed in [3, 5, 8]:  # Fibonacci seeds
    # set seed
